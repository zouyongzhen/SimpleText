...
import zyz.hero.textlib.widget.fold.FoldText
import zyz.hero.textlib.widget.fold.handler.HighLightHandler
import zyz.hero.textlib.widget.fold.handler.QuoteHandler
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foldText.setOnButtonClickListener {
