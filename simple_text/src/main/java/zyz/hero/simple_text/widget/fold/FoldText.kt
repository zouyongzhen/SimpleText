...
open class FoldText @JvmOverloads constructor(
    ...
    init {
        ...
        textColor = typedArray.getColor(R.styleable.FoldText_textColor, Color.parseColor("#333333"))
        textLineSpacingMultiplier = typedArray.getFloat(R.styleable.FoldText_textLineSpacingMultiplier, 1.2f)
        textLineSpacing = typedArray.getFloat(R.styleable.FoldText_textLineSpacing, 0f)
